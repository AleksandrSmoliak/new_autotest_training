...
class test_add_contact(unittest.TestCase):
    ...
    def test_test_add_contact(self):
        ...
        self.add_new_contact(wd, Contact(firstname="Александр", middlename="Смоляк", lastname="Владимирович", nickname="crucis", title="Заголовок", company_name="Имя компании",
    ...
    def add_new_contact(self, wd, contact):
        ...
        if not wd.find_element_by_xpath(contact.birthday_selected).is_selected():
            wd.find_element_by_xpath(contact.birthday_selected).click()
        if not wd.find_element_by_xpath(contact.birthmont_selected).is_selected():
            wd.find_element_by_xpath(contact.birthmont_selected).click()
